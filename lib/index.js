...
class AWSClient
{
    ...
    getAwsService(name)
    {
        ...
        return this._awsServices[name].awsService;
    }

    _constructWrappedService(awsServiceInfo)
    {
        awsServiceInfo.throttler = ThrottledQueue(10, 1000, true);
        this._logger.info('AWS Service %s Keys: ', awsServiceInfo.name, Object.keys(awsServiceInfo.awsService));
    }
