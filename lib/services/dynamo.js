...
class AWSDynamoClient
{
    ...
    _create(name, config)
    {
        ...
        return this._dynamoDb.createTable(params).promise()
            .then(result => {
    ...
    update(name, config)
    {
        ...
        return this._dynamoDb.updateTable(params).promise()
            .then(result => {
    ...
    delete(name)
    {
        ...
        return this._dynamoDb.deleteTable(params).promise()
            .catch(reason => {
    ...
    query(name) {
        ...
        return this._dynamoDb.describeTable(params).promise()
            .catch(reason => {
                if (reason.code == 'ResourceNotFoundException') {
                    return null;
                } else {
