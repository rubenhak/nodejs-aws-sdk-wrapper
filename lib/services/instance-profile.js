...
class AWSInstanceProfileClient
{
    ...
    queryAll(path, marker, result)
    {
        ...
        return this._iam.listInstanceProfiles(params).promise()
            .then(data => {
    ...
    query(name)
    {
        ...
        return this._iam.getInstanceProfile(params).promise()
            .then(data => {
                return data.getInstanceProfile;
            });
    }
    ...
    create(name, path)
    {
        ...
        return this._iam.createInstanceProfile(params).promise()
            .then(data => {
    ...
    delete(name)
    {
        ...
        return this._iam.deleteInstanceProfile(params).promise()
            .then(data => {
    ...
    addRole(name, roleName)
    {
        ...
        return this._iam.addRoleToInstanceProfile(params).promise()
            .then(data => {
    ...
    removeRole(name, roleName)
    {
        ...
        return this._iam.removeRoleFromInstanceProfile(params).promise()
            .then(data => {
