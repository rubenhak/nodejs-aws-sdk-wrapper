...
class AWSVolumeClient
{
    ...
    query(id) {
        ...
        return this._ec2.describeVolumes({ VolumeIds: [ id ] })
            .then(data => {
    ...
    queryAll(tags, res, next) {
        ...
        return this._ec2.describeVolumes(params)
            .then(result => {
                res = res.concat(result.Volumes);
                if (result.NextToken) {
                    return queryAll(tags, res, result.NextToken);
                }
                return res;
            });
    }
    ...
    create(params) {
        ...
        return this._ec2.createVolume(params)
            .then(volume => {
    ...
    createSnapshot(volumeId) {
        ...
        return this._ec2.createSnapshot(params)
            .then(snapshot => {
    ...
    _waitSnapshotReady(snapshot) {
        ...
        return Promise.timeout(5 * 1000)
            .then(() => {
                return this._ec2.describeSnapshots({ SnapshotIds: [ snapshot.SnapshotId ] });
            })
            .then(data => {
    ...
    deleteSnapshot(snapshotId)
    {
        ...
        return this._ec2.deleteSnapshot(params)
            .catch(reason => {
    ...
    delete(volumeId)
    {
        ...
        return this._ec2.deleteVolume(params)
            .catch(reason => {
    ...
    attach(volumeId, instanceId, deviceName)
    {
        ...
        return this._ec2.attachVolume(params)
            .then(result => {
    ...
    detach(volume, instanceId)
    {
        ...
        return this._ec2.detachVolume(params)
            .then(result => {
