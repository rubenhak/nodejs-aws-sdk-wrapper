...
class AWSKeyManagementClient
{
                ...
                return Promise.serial(data, keyObj => {
                    return this._queryKeyTagsAndFilter(keyObj.KeyId, tags)
                        .then(myTags => {
                            ...
                            return this._queryKeyPolicy(keyObj.KeyId)
                                .then(policy => {
                                    keyObj.Policy = policy;
                                    return keyObj;
                                });
                        });
                })
    ...
    queryKey(id)
    {
        ...
        return this._kms.describeKey(params)
            ...
            .then(data => {
                obj.Tags = data;
                return this._queryKeyPolicy(id);
            })
            .then(data => {
                obj.Policy = data;
            })
    ...
    _queryKeyPolicy(id)
    {
        ...
        return this._kms.getKeyPolicy(params)
            .then(data => {
                return JSON.parse(data.Policy);
            });
    }

    createKey(config, tags, policy)
    {
        var params;
        if (config) {
    ...
    updateKeyPolicy(id, policy)
    {
        ...
        return this._kms.putKeyPolicy(params);
    }
