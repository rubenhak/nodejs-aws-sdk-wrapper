...
class AWSRoleClient
{
    ...
    queryAll(path, marker, result)
    {
        ...
        return this._iam.listRoles(params)
            .then(data => {
    ...
    query(name)
    {
        ...
        return this._iam.getRole(params)
            .then(data => {
                if (!data.Role) {
                    return null;
                }
    ...
    _getAttachedPolicies(roleName, marker, result)
    {
        ...
        return this._iam.listAttachedRolePolicies(params)
            .then(data => {
    ...
    create(name, path, policyDoc)
    {
        ...
        return this._iam.createRole(params)
            .then(data => {
    ...
    update(role, policyDoc)
    {
        ...
        return this._iam.updateAssumeRolePolicy(params)
            .then(data => {
    ...
    remove(name)
    {
        ...
        return this._iam.deleteRole(params)
            .then(data => {
    ...
    attachPolicy(role, policyArn)
    {
        ...
        return this._iam.attachRolePolicy(params)
            .then(data => {
    ...
    detachPolicy(role, policyArn)
    {
        ...
        return this._iam.detachRolePolicy (params)
            .then(data => {
