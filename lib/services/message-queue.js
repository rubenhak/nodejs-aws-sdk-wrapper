...
class AWSMessageQueueClient
{
    ...
    queryAll(cluster)
    {
        ...
        return this._sqs.listQueues(params)
            .then(result => {
    ...
    create(name, fifoQueue, attributes, tags)
    {
        ...
        return this._sqs.createQueue(params)
            .then(result => {
    ...
    delete(url) {
        ...
        return this._sqs.deleteQueue(params);
    }
    ...
    _setupTags(url, tags)
    {
        ...
        return this._sqs.tagQueue(params);
    }
    ...
    _getTags(url) {
        ...
        return this._sqs.listQueueTags(params)
            .then(result => {
    ...
    query(url)
    {
        ...
        return this._sqs.getQueueAttributes(params)
            .catch(error => {
                    queue = null;
                    return null;
                })
    ...
    update(url, attributes)
    {
        ...
        return this._sqs.setQueueAttributes(params);
    }
    ...
    sendMessage(queueUrl, data)
    {
        ...
        this.logger.info('Sending Message to Queue %s...', queueUrl);
        this.logger.verbose('Sending Message to Queue:', params);
        return this._sqs.sendMessage(params);
    }
}
