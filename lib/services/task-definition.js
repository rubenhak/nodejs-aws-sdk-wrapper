...
class AWSTaskDefinitionClient
{
    ...
    query(name) {
        ...
        return this._ecs.describeTaskDefinition(params)
            .then(result => {
    ...
    _queryAllArns(prefix, res, next) {
        ...
        return this._ecs.listTaskDefinitions(params)
            .then(result => {
    ...
    _create(params)
    {
        ...
        return this._ecs.registerTaskDefinition(params)
            .then(result => {
    ...
    delete(arn)
    {
        ...
        return this._ecs.deregisterTaskDefinition(params)
            .then(result => {
            });
    }
}
