...
class AWSNetworkInterfaceClient
{
    ...
    create(cluster, service, id, subnetId, sgId)
    {
        ...
        var niId = null;
        this.logger.info('Creating NetworkInterface %s-%s-%s...', cluster, service, id);
    ...
    attach(niId, instanceId, deviceIndex)
    {
        ...
        this.logger.info('Attaching NetworkInterface %s to %s :: %s...', niId, instanceId, deviceIndex);
    ...
    detach(ni)
    {
        ...
        this.logger.info('Detaching NetworkInterface %s from %s...', ni.Attachment.NetworkInterfaceId, ni.Attachment.InstanceId);
