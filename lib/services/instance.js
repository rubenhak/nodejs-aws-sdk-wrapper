...
class AWSInstanceClient
{
    ...
    queryAll(tags, nextToken, results)
    {
        ...
        return this._ec2.describeInstances(params)
            .then(data => {
    ...
    query(id) {
        ...
        return this._ec2.describeInstances({ InstanceIds: [ id ] })
            .then(data => {
                this.logger.verbose('Instance %s Query result: ', id, data);
    ...
    run(tags, waitStabilize)
    {
        ...
        return this._ec2.runInstances(params)
            .then(data => {
    ...
    terminate(instanceId)
    {
        ...
        return this._ec2.terminateInstances(params)
            .then(data => {
